...
CATEGORIES = [
    ...
    ['N', 'Y'],
    [
        'Building a house or an annex', 'Business development',
    ...
    [
        ...
        'Consumer Electronics', 'Direct Sales', 'Education', 'Fitness',
        'Furniture', 'Gardening', 'Homewares', 'House Construction',
        'Insurance', 'Jewelry', 'Medical Supplies', 'Medicine', 'Mobile',
        'Office Appliances', 'Other', 'Photo / Cinema Equipment',
        'Sport and Leisure', 'Tourism', 'Vehicles', 'Weapon', 'XNA',
    ],
    ['Cards', 'Cars', 'Cash', 'POS', 'XNA'],
    ['XNA', 'walk-in', 'x-sell'],
    [
        'AP+ (Cash loan)', 'Car dealer', 'Channel of corporate sales',
        'Contact center', 'Country-wide', 'Credit and cash offices',
        'Regional / Local', 'Stone',
    ],
    [
        'Auto technology', 'Clothing', 'Connectivity', 'Construction',
        'Consumer electronics', 'Furniture', 'Industry', 'Jewelry',
        'MLM partners', 'Tourism', 'XNA',
    ],
    ['XNA', 'high', 'low_action', 'low_normal', 'middle'],
    [
        'Card Street', 'Card X-Sell', 'Cash', 'Cash Street: high',
        'Cash Street: low', 'Cash Street: middle', 'Cash X-Sell: high',
        'Cash X-Sell: low', 'Cash X-Sell: middle',
        'POS household with interest', 'POS household without interest',
        'POS industry with interest', 'POS industry without interest',
        'POS mobile with interest', 'POS mobile without interest',
        'POS other with interest', 'POS others without interest',
    ],
]


def previous_application() -> pd.DataFrame:
    """Preprocess previous application."""
    prev = load_data(f'{BUCKET}/auxiliary/previous_application.csv')
